...
SWIFT_CLASS("_TtC26ClearentIdtechIOSFramework31ClearentRoundedCornersStackView")
@interface ClearentRoundedCornersStackView : ClearentAdaptiveStackView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end

@class ClearentTitleLabel;
...
@property (nonatomic, strong) IBOutlet ClearentTitleLabel * _Null_unspecified titleLabel;
@property (nonatomic, strong) IBOutlet ClearentRoundedCornersStackView * _Null_unspecified settingsStackView;
@property (nonatomic, strong) IBOutlet ClearentPrimaryButton * _Null_unspecified doneButton;
...
- (BOOL)shouldDisplayOfflineModeLabelWithIgnorePromptMode:(BOOL)ignorePromptMode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
