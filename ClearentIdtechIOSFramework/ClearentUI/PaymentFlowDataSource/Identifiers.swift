...
public enum ProcessType {
    case pairing(withReader: ReaderInfo? = nil, firstPairing: Bool = false), payment, showReaders
...
public enum FlowButtonType {
    case cancel, retry, pair, done, startPairNewReader, settings, newPairing
