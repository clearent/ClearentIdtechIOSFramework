...
/// All screens that should have a maximum width (for iPad support) inherit from this class. The width can be set by updating ClearentConstants.Size.defaultScreenMaxWidth.
