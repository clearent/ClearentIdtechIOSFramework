...
@objc public class ClearentConstants: NSObject {
    ...
    public enum ContactSupport {
        public static let phoneNumber = "xsdk_contact_support_phone_number".localized
    }
    ...
    enum Localized {
        ...
        enum OfflineMode {
            ...
            public static let offlineModeEncryptionContactSupport = "xsdk_offline_mode_encryption_call_support".localized
