...
class ClearentOfflineModeReportPresenter {
    ...
    func updateDataSource() {
        ...
        let result = [ReportItem(itemName: ClearentConstants.Localized.OfflineReport.approvedCount, itemValue: String(approvedCount), isAmount: false),
                      ReportItem(itemName: ClearentConstants.Localized.OfflineReport.approvedAmount, itemValue: approvedAmount.stringFormattedWithTwoDecimals ?? "-", isAmount: true),
                      ...
                      ReportItem(itemName: ClearentConstants.Localized.OfflineReport.declinedAmount, itemValue: declinedAmount.stringFormattedWithTwoDecimals ?? "-", isAmount: true),
                      ReportItem(itemName: ClearentConstants.Localized.OfflineReport.errorCount, itemValue: String(errorCount), isAmount: false),
                      ReportItem(itemName: ClearentConstants.Localized.OfflineReport.errorAmount, itemValue: errorAmount.stringFormattedWithTwoDecimals ?? "-", isAmount: true),
        ]
