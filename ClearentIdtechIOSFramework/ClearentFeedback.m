...
NSString *const CLEARENT_USER_ACTION_USE_MAGSTRIPE_MESSAGE = @"USE MAGSTRIPE";
...
NSString *const CLEARENT_SUCCESSFUL_TOKENIZATION_MESSAGE = @"CARD READ OK, REMOVE CARD";
NSString *const CLEARENT_TRANSLATING_CARD_TO_TOKEN = @"READING CARD";
...
+ (NSDictionary*) feedbackValues {
    return @{
            ...
            CLEARENT_MSD_CONTACTLESS_UNSUPPORTED : [NSNumber numberWithInt:CLEARENT_FEEDBACK_ERROR],
            ...
            CLEARENT_USER_ACTION_USE_MAGSTRIPE_MESSAGE : [NSNumber numberWithInt:CLEARENT_FEEDBACK_USER_ACTION],
            ...
            CLEARENT_SUCCESSFUL_TOKENIZATION_MESSAGE : [NSNumber numberWithInt:CLEARENT_FEEDBACK_USER_ACTION],
            ...
            CLEARENT_PLEASE_WAIT : [NSNumber numberWithInt:CLEARENT_FEEDBACK_INFO],
            ...
            CLEARENT_BAD_CHIP : [NSNumber numberWithInt:CLEARENT_FEEDBACK_INFO],
