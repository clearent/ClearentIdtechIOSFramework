...
/**
 * This protocol is used to communicate information and results regarding the interaction with the SDK.
 */
public protocol ClearentWrapperProtocol : AnyObject {
    /**
     * Method called after a pairing process and a bluetooth search is started.
     */
    ...
    /**
     * Method called when the process of posting a transaction receipt has completed
    ...
    /**
     * Method called when an offline email was successfully saved.
     * @param status transactionID, the id of the offline transaction
     */
