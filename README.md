...
1. **Enhanced Messages**, when this feature is enabled, the feedback that the SDK is providing uses friendlier messages, this messages are stored in the enhancedmessages-v1.txt file from the ClearentIdtechMessages bundle.
    The host app will need to include the bundle in build phases copy resources section.
